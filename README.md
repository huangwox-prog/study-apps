...
> **開発体制について**  
> 本リポジトリの開発では、AIコーディングツール「Claude Code」を使用しています。  
> 利用にあたっては保護者の許可を得たうえで、保護者のアカウントを使用し、保護者の監督のもとで作業しています。  
> Claude Codeへの指示（プロンプト）は、内容を保護者と確認し、最終的に保護者が送信しています。  
> 生成されたコードは、内容を確認・理解したうえで取り入れています。
