...
export default {
  ...
  diagnostic: [
    ...
    },
    {
      ...
      choices: ["`frac(sqrt(2),2)`", "`frac(sqrt(2),4)`", "`sqrt(2)`", "`frac(1,2)`"],
      answer: 0,
      mistakeType: "calc",
  ...
  practice: [
    ...
    },
    {
      ...
      choices: ["`4sqrt(3)`", "`sqrt(14)`", "`4sqrt(2)`", "`48`"],
      answer: 0,
      mistakeType: "calc",
      exp: "`sqrt(6)×sqrt(8)=sqrt(48)`。`48=16×3` なので `4sqrt(3)`。中身を足して `sqrt(14)` としたり、`48=16×2` と分けたりしないこと。",
    },
    {
      id: "ns4-p8", type: "choice", level: 2,
      q: "`frac(3,sqrt(3))` を有理化すると?",
      choices: ["`sqrt(3)`", "`3sqrt(3)`", "`frac(sqrt(3),3)`", "`1`"],
      answer: 0,
      mistakeType: "calc",
      exp: "分母・分子に `sqrt(3)` をかけて `frac(3sqrt(3),3)=sqrt(3)`。3どうしを先に約分して `1` としないこと。",
    },
    {
  ...
  test: [
    ...
    },
    {
      ...
      q: "`sqrt(45)` を簡単にすると?",
      choices: ["`3sqrt(5)`", "`5sqrt(3)`", "`9sqrt(5)`", "`15sqrt(3)`"],
      answer: 0,
      mistakeType: "calc",
      exp: "`45=9×5` と平方数で分ける。`sqrt(9)=3` を外に出して `3sqrt(5)`。`45=15×3` と分けても15は外に出せない。",
    },
    {
      id: "ns4-t3", type: "choice",
      q: "`sqrt(3)×sqrt(15)` を計算すると?",
      choices: ["`3sqrt(5)`", "`sqrt(18)`", "`15sqrt(3)`", "`45`"],
      answer: 0,
      mistakeType: "calc",
      exp: "`sqrt(3)×sqrt(15)=sqrt(45)`(中身はかけ算。足して `sqrt(18)` ではない)。`45=9×5` なので `3sqrt(5)`。",
    },
    {
