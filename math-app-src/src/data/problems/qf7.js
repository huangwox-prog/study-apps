...
export default {
  ...
  practice: [
    ...
    {
      id: "qf7-p10", type: "choice", level: 3,
    ...
    {
      id: "qf7-p11", type: "choice", level: 3,
    ...
    {
      id: "qf7-p12", type: "choice", level: 3,
  ...
  test: [
    ...
    {
      id: "qf7-t10", type: "choice", level: 3,
      q: "【応用】グラフが `x` 軸と `x=1, 3` で交わり、点 `(0, 6)` を通る二次関数は?",
      choices: [
        "`y=2(x-1)(x-3)`",
        "`y=(x-1)(x-3)`",
        "`y=3(x-1)(x-3)`",
    ...
    {
      id: "qf7-t11", type: "choice", level: 3,
